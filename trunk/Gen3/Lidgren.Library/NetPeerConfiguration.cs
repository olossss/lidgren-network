...
namespace Lidgren.Network
{
	...
	public sealed class NetPeerConfiguration
	{
		...
		public NetPeerConfiguration(string appIdentifier)
		{
			...
			// 20 bytes ip header
			//  8 bytes udp header
			//  9 bytes lidgren header (packet + message header)
		...
		/// <summary>
		/// Gets or sets the maximum number of seconds to wait before sending an explicit (empty) packets with an acknowledge
		/// </summary>
		public float MaxExplicitAckDelay
		{
